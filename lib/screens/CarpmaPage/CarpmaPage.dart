...
import 'CarpmaPageBody.dart';

class CarpmaPage extends StatefulWidget {
  const CarpmaPage({super.key});

  @override
  State<CarpmaPage> createState() => _CarpmaPageState();
}
...
class _CarpmaPageState extends State<CarpmaPage> {
  ...
  Future<List<CarpmaModel>> getData() async {
    return db.fetchCarpQuestion();
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _questions as Future<List<CarpmaModel>>,
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.hasError) {
            ...
            var extractData = snapshot.data as List<CarpmaModel>;
            return Scaffold(
